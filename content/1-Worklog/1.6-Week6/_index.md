...
| 5 | Infrastructure as Code & Cloud Deployment (AWS SAM)<br>- Configured the `template.yaml` file using AWS SAM to declare all resources (Lambda, API Gateway, Aurora, S3, Cognito, Step Functions, SNS).<br>- Executed build and deploy commands to provision the infrastructure stack onto AWS Cloud (`edms-lambda-stack`). | 01/08/2026 | 02/08/2026 |
