...
| 5 | Hạ tầng bằng Code & Triển khai Đám mây (AWS SAM)<br>- Cấu hình file `template.yaml` bằng AWS SAM để khai báo toàn bộ tài nguyên (Lambda, API Gateway, Aurora, S3, Cognito, Step Functions, SNS).<br>- Thực thi build và deploy cấu hình hạ tầng lên AWS Cloud (`edms-lambda-stack`). | 01/08/2026 | 02/08/2026 |
